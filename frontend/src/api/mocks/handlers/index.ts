...
export const handlers = [...authHandlers, ...categoryHandlers, ...locationHandlers, ...supplierHandlers, ...userHandlers, ...stockHandlers, ...productHandlers, ...purchaseOrderHandlers, ...stockMovementHandlers]
