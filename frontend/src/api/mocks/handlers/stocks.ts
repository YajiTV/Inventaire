...
type StockCreate = components['schemas']['StockCreate']
type StockUpdate = components['schemas']['StockUpdate']

let stocks: StockRead[] = [
  { id: 1, product_id: 1, location_id: 1, quantity: 25 },
]
let nextId = 2
...
export const stockHandlers = [
  ...
  // StockUpdate ne permet de modifier que la quantité (product_id/location_id fixent
  // la contrainte d'unicité côté backend, ils ne se changent pas après coup).
